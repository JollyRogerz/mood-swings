...
cube("Preview only · 45 sleeved cards", (0, 0, 48.85), (66, 26, 92), card_1)
...
# Blender adds the local .blend path to PNG text metadata. Keep the picture,
# but omit metadata before publishing it in a public repository.
...
preview.write_bytes(clean)
print(f"Saved {ROOT / 'mood_deck_case.blend'} and {ROOT / 'preview.png'}")
