...
scene.render.filepath = "//preview_open.png"  # Keep the saved .blend portable.
...
body = load_print("Upright deck case · body", ROOT / "body.stl")
...
lid.location = (35, 0, body.dimensions.z + 23)  # Open, moving right from the standing body.
...
camera_data.ortho_scale = 192
scene.camera = camera

scene.view_settings.view_transform = "AgX"
scene.render.film_transparent = False
bpy.ops.wm.save_as_mainfile(filepath=str(ROOT / "mood_upright_v2.blend"))
...
for image_name in ("preview_open.png", "preview_closed.png"):
    strip_png_metadata(ROOT / image_name)
print(f"Saved {ROOT / 'mood_upright_v2.blend'} and both previews")
