...
an editable OpenSCAD model, and Blender previews. The off-register title,
broken mood wheel, die motif, and wrapped side ribbons draw on Mood Swings'
zine aesthetic, while
